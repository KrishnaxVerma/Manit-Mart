...
export default function ProductCard({ product, onInterested }) {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md transition cursor-pointer">
      ...
      >
        <div className="relative w-24 h-32 bg-gray-200 rounded flex items-center justify-center overflow-hidden">
          {images.length > 0 ? (
            <>
              <img 
              ...
              />
              <div className="absolute inset-0 bg-gray-200 rounded flex items-center justify-center" style={{ display: 'none' }}>
            ...
            <button
              ...
              className={`px-3 py-1 rounded text-sm transition ${
                isInterested 
                  ...
                  : 'bg-pink-500 text-white hover:bg-pink-600 disabled:bg-gray-300'
              }`}
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <span className="text-sm text-gray-500">Interested Users:</span>
                      <p className="font-medium">{product.interested?.length || 0} people interested</p>
                    </div>
                  </div>
                </div>
              </div>
